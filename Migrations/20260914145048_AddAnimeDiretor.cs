...
{
    /// <inheritdoc />
    public partial class AddAnimeDiretor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroEpisodios = table.Column<int>(type: "integer", nullable: false),
                    DiretorId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
